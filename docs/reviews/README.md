...
| 2026-09-23 | Phase 6 effects/transitions UI (`2026-09-23-phase6-review.md`, kept) | 11 (linked crossfade length, layer-missing flash on seek, preference refresh, status line, and lows) | open |
