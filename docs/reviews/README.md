...
| 2026-09-23 | Phase 7 export (`2026-09-23-phase7-review.md`, kept) | 10 (destroys pre-existing output on cancel/failure, fails on video shorter than container, silent audio on decode error, sandbox URL extension) | phase 7 fix round (working file + atomic replace, videoDuration + end-of-video hold, audio read failures, container re-choose, lows); test gaps 7-9 open |
