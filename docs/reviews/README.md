...
| 2026-09-23 | Full pass after phase 5b (`2026-09-23-full-review.md`, kept) | 12 new (cross-project id aliasing, coalescing group absorbs edits, bin Delete, dual playback, cache poisoning, keyboard focus); all earlier groups Held or Partially | open |
