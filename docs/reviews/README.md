...
| 2026-09-23 | Full pass after phase 5b (`2026-09-23-full-review.md`, kept) | 12 new (cross-project id aliasing, coalescing group absorbs edits, bin Delete, dual playback, cache poisoning, keyboard focus) + 4 scaffold; all earlier groups Held or Partially | 2026-09-23 fix round (media epochs, coalescing tokens, monitor exclusivity, Distribution signing, LGPL notices, warnings as errors); two test gaps open |
