...
| 2026-09-24 | Effect lanes rounds 1, 1b, 2 (`2026-09-24-effect-lanes-review.md`, kept until fixed) | 1 CRITICAL (Ken Burns editor on a scaled/offset clip), 4 HIGH (v4 open refusal, cancelled drag reopened, stale drop pill and lane reveal, dissolve-to-fade surprise), 8 MEDIUM, 11 LOW, 3 design items from hands-on notes; 6 test-gap groups | open |
